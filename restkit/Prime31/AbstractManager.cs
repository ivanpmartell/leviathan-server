...
namespace Prime31
{
	public abstract class AbstractManager : MonoBehaviour
	{
		...
		public static void initialize(Type type)
		{
			...
			{
				Debug.LogWarning($"It looks like you have the {type} on a GameObject in your scene. Our new prefab-less manager system does not require the {type} to be on a GameObject.\nIt will be added to your scene at runtime automatically for you. Please remove the script from your scene.");
			}
		}
