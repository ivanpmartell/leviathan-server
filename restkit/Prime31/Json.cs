...
namespace Prime31
{
	public class Json
	{
		internal class Deserializer
		{
			...
			{
				return deserialize(json, useGenericContainers: true);
			}
			...
			{
				IDictionary dictionary = (IDictionary)((!_useGenericContainers) ? ((object)new Hashtable()) : ((object)new Dictionary<string, object>()));
				nextToken(json, ref index);
				bool flag = false;
				while (!flag)
				{
		...
		{
			return jsonDecode(json, decodeUsingGenericContainers: false);
		}
