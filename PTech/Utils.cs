...
internal class Utils
{
	...
	{
		Console.WriteLine("Dumping memory usage to " + Directory.GetCurrentDirectory() + "memory_*.csv");
...
/*	public static bool IsAndroidBack()
	...
	{
		Console.WriteLine("partzz " + ps.particleCount + " on " + ps.gameObject.name);
	...
	public static void LoadParticles(ParticleSystem ps, BinaryReader stream)
	{
		...
		Console.WriteLine("loaded particles " + ps.particleCount);
	}
	...
	{
		debugOutput = "No textures in the server version.";
		return false;
	}
}
