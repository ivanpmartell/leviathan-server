...
public class ComponentDB
{
	...
	public UnitSettings GetUnit(string name)
	{
		...
		Console.WriteLine("Failed to find unit " + name);
		return null;
	}
	...
	public HPModuleSettings GetModule(string name)
	{
		...
		Console.WriteLine("Failed to find module " + name);
		return null;
	}
	...
	public SectionSettings GetSection(string name)
	{
		...
		Console.WriteLine("Failed to find section " + name + " Check that it is included in base_components.xml");
		return null;
	}
}
