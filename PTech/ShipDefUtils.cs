...
internal class ShipDefUtils
{
	...
	public static int GetShipValue(ShipDef ship, ComponentDB cdb)
	{
		...
		if (unit == null)
		{
			Console.WriteLine("Missing prefab in cdb: " + ship.m_prefab);
			return -1;
		}
		num += unit.m_value;
	...
	private static int GetSectionValue(SectionDef section, ComponentDB cdb)
	{
		...
		if (section2 == null)
		{
			Console.WriteLine("Missing section prefab in cdb:" + section.m_prefab);
			return -1;
		}
		...
		foreach (ModuleDef module2 in section.m_modules)
		{
			...
			if (module == null)
			{
				Console.WriteLine("Missing module prefab in cdb:" + module2.m_prefab);
				return -1;
			}
			num += module.m_value;
		}
